            ...
            <form class="space-y-4" action="{{ route('registrasi.proses') }}" method="POST">
                ...
                <div>
                    ...
                    <input id="username" type="text" name="username" placeholder="Nama Pengguna"
                        value="{{ old('username') }}" required pattern="[A-Za-z0-9_]{5,20}"
                ...
                <div>
                    ...
                    <select id="status" name="status" required value="{{ old('status') }}"
                        class="w-full px-4 py-3 text-gray-500 placeholder-gray-500 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 md:text-lg">
