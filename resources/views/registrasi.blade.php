...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-b from-black to-blue-400">
            ...
            <form class="space-y-4" action="#" method="POST">
                ...
                <div>
                    ...
                    <select id="status" name="status" required
                            class="w-full px-4 py-3 text-gray-500 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 md:text-lg">
                ...
                <div class="relative">
                    ...
                    <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer" onclick="togglePassword('password', 'eye')">
                        <svg id="eye" class="w-6 h-6 text-black hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path id="eye-open" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-.254.815-.63 1.582-1.122 2.276M19.07 19.07A9.953 9.953 0 0112 21a9.954 9.954 0 01-7.071-2.929M9.88 9.88A3 3 0 1014.12 14.12"></path>
                            <path id="eye-slash" class="hidden" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M15.6 15.6A5 5 0 119.4 9.4m5.6 6.2L9.4 9.4"></path>
                        </svg>
                    </span>
                </div>
                ...
                <div class="relative">
                    ...
                    <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Konfirmasi Kata Sandi" required
                           class="w-full px-4 py-3 text-black placeholder-gray-500 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 md:text-lg">
                    <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer" onclick="togglePassword('password_confirmation', 'eye-confirm')">
                        <svg id="eye-confirm" class="w-6 h-6 text-black hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path id="eye-open" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-.254.815-.63 1.582-1.122 2.276M19.07 19.07A9.953 9.953 0 0112 21a9.954 9.954 0 01-7.071-2.929M9.88 9.88A3 3 0 1014.12 14.12"></path>
                            <path id="eye-slash" class="hidden" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M15.6 15.6A5 5 0 119.4 9.4m5.6 6.2L9.4 9.4"></path>
                        </svg>
